  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        sessionStorage.setItem("toastMessage", "true");
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full border rounded-xl p-2.5 text-gray-800 focus:outline-none focus:ring-2 transition ${email && !emailValido
      ...
      <div className="relative">
        ...
        <div className="relative">
          <input
            ...
            className={`w-full border rounded-xl p-2.5 pr-10 text-gray-800 focus:outline-none focus:ring-2 transition ${password && (!longitudValida || !contrasenasCoinciden)
                ? "border-red-500 focus:ring-red-400"
                : "border-gray-300 focus:ring-servineo-400"
              }`}
            required
      ...
      <div className="relative">
        ...
        <div className="relative">
          <input
            ...
            className={`w-full border rounded-xl p-2.5 pr-10 text-gray-800 focus:outline-none focus:ring-2 transition ${confirmarPassword && !contrasenasCoinciden
                ? "border-red-500 focus:ring-red-400"
                : "border-gray-300 focus:ring-servineo-400"
              }`}
            required
      ...
      {mensaje && (
        <p
          className={`text-center text-sm font-medium mt-3 ${mensaje.startsWith("✅") ? "text-green-600" : "text-red-600"
            }`}
        >
          {mensaje}
        </p>
