    ...
    <div style={{ position: "relative", width: "100%" }}>
      ...
      >
        ...
        <div style={{ width: "100%", marginBottom: "1rem" }}>
          ...
          >
            Ejemplo: {paisSeleccionado?.ejemplo} ({paisSeleccionado?.longitudMin}-{paisSeleccionado?.longitudMax} dígitos)
          </p>
        </div>
        ...
        {error && (
          ...
          >
            <p style={{ fontSize: "0.875rem", color: "#C62828", margin: 0 }}>
              ⚠️ {error}
            </p>
          </div>
        )}
